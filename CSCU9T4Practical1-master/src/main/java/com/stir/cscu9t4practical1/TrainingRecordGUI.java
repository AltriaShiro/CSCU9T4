...
public class TrainingRecordGUI extends JFrame implements ActionListener {
    ...
    //private JTextField where = new JTextField(3);
    ...
    private JButton clearSelectedEntry = new JButton("Clear Selected Entry");
    ...
    public TrainingRecordGUI() {
        ...
        add(clearSelectedEntry);
        clearSelectedEntry.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (event.getSource ()== clearSelectedEntry) {
    ...
    public void ClearSelectedEntry() {
         ...
         int y = Integer.parseInt(year.getText());
         String n = name.getText();
         outputArea.setText("Clearing..");
         myAthletes.clearSelectedEntry(n, d, m, y);
    }
